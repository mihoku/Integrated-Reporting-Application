namespace ira.Migrations
{
    ...
    public partial class welcome : DbMigration
    {
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Detail = c.String(),
                        PimpinanUnitID = c.Int(nullable: false),
                        RefPegawai_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.RefPegawais", t => t.RefPegawai_ID)
                .Index(t => t.RefPegawai_ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.RefUnitPJs", "RefPegawai_ID", "dbo.RefPegawais");
            ...
            DropIndex("dbo.RefUnitPJs", new[] { "RefPegawai_ID" });
